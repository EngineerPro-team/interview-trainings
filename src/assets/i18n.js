...
window.I18N = {
  vi: {
    ...
    "resources.formats.disclaimer.body": "Process thực tế phụ thuộc team, hiring manager, location và thời điểm tuyển. Một số công ty (Shopee, Nvidia, ANZ×HCL…) ghi chú rõ từng team có thể khác nhau.",
  ...
  en: {
    ...
    "resources.formats.disclaimer.body": "Actual process depends on team, hiring manager, location, and timing. Some companies (Shopee, Nvidia, ANZ×HCL…) note that teams may differ.",
