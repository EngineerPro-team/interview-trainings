...
window.I18N = {
  vi: {
    ...
    "mentors.intro.html":
      '<span id="mentorsCount">17</span> mentor đang làm việc tại Google, Amazon, Meta, TikTok, Spotify, Shopee, Acronis, AWS… Bấm vào nút LinkedIn để xem profile.',
  ...
  en: {
    ...
    "mentors.intro.html":
      '<span id="mentorsCount">17</span> mentors currently at Google, Amazon, Meta, TikTok, Spotify, Shopee, Acronis, AWS… Click LinkedIn to see their profile.',
    "mentors.cta.linkedin": "LinkedIn",
