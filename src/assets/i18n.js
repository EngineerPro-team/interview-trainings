...
window.I18N = {
  vi: {
    ...
    "resources.intro":  "Bộ tài nguyên miễn phí team EngineerPro share cho cộng đồng — checklist HR phone screen, video nền tảng lập trình, template CV chuẩn Big Tech, và playlist review CV thực tế.",
    ...
    "resources.hr.intro": "Nhiều bạn rớt sớm không phải vì coding, mà vì HR/recruiter hỏi self-intro, behaviour, project depth và motivation — và cảm thấy bạn chưa “own” công việc mình làm hoặc chưa thật sự muốn vào công ty. Tick từng mục trước khi nhấc máy.",
    "resources.hr.item1.title": "1 · Tell me about yourself",
    "resources.hr.item1.why": "Mở đầu ~90 giây – 2 phút — HR quyết định có muốn đẩy bạn sang vòng sau không.",
    "resources.hr.item1.t1": "Present → Past → Future: role hiện tại, 1–2 highlight có số liệu, vì sao apply vị trí/công ty này.",
    "resources.hr.item1.t2": "Không đọc CV từng dòng; kết bằng hook “That’s why I’m excited about …”.",
    "resources.hr.item1.t3": "Luyện nói to, rõ — tránh monologue quá 3 phút.",
    "resources.hr.item2.title": "2 · Behavioural / situational (STAR)",
    ...
    "resources.hr.item3.title": "3 · Past projects — chứng minh bạn nắm việc mình làm",
    "resources.hr.item3.why": "HR/recruiter thường drill 1–2 project trên CV để xem có “resume inflation” không.",
    "resources.hr.item3.t1": "Chọn 2 project gần nhất: problem, scope của bạn, trade-offs, outcome, stack — nói được không cần slide.",
    "resources.hr.item3.t2": "Walk-through flow / architecture ở mức high-level; sẵn sàng giải thích 1 quyết định kỹ thuật bạn chịu trách nhiệm.",
    "resources.hr.item3.t3": "Project team → nói rõ phần việc của bạn; đừng claim credit cả team.",
    "resources.hr.item4.title": "4 · Motivation — why company / why role",
    "resources.hr.item4.why": "Thiếu motivation cụ thể = red flag “ứng tượng trúng đâu hay đấy”.",
    "resources.hr.item4.t1": "Research 3 điểm cụ thể: sản phẩm, culture/values, scope level role — không chỉ “công ty lớn”.",
    "resources.hr.item4.t2": "Nối motivation với mục tiêu nghề nghiệp 2–3 năm của bạn.",
    "resources.hr.item4.t3": "Không diss công ty cũ; compensation chỉ là một phần của câu trả lời.",
    "resources.hr.item5.title": "5 · Logistics & chuyên nghiệp",
    ...
    "resources.hr.item5.t2": "Chuẩn bị 2–3 câu hỏi ngược: process, team structure, timeline các vòng sau.",
    "resources.hr.item5.t3": "Test mic/line; chỗ yên tĩnh; CV + JD mở sẵn trước mặt.",
    "resources.hr.item6.title": "6 · Sau cuộc gọi",
    ...
    "resources.hr.item6.t2": "Thank-you note ngắn trong 24h (optional nhưng tăng impression).",
  ...
  en: {
    ...
    "resources.head":   "Interview Resources",
    "resources.badge":  "FREE",
    "resources.intro":  "Free resources the EngineerPro team shares with the community — HR phone screen checklist, programming foundation videos, Big Tech CV templates, and a real CV review playlist.",
    "resources.hr.kicker": "✅ CHECKLIST · HR PHONE SCREEN",
    ...
    "resources.hr.intro": "Many candidates drop out early not because of coding, but because HR/recruiters probe self-intro, behaviour, project depth, and motivation — and sense you don't own your work or aren't genuinely interested in the company. Run through this list before you pick up.",
    "resources.hr.item1.title": "1 · Tell me about yourself",
    "resources.hr.item1.why": "Opening ~90 seconds – 2 minutes — HR decides whether to push you to the next round.",
    "resources.hr.item1.t1": "Present → Past → Future: current role, 1–2 quantified highlights, why this role/company.",
    "resources.hr.item1.t2": "Don't read your CV line by line; close with “That's why I'm excited about …”.",
    "resources.hr.item1.t3": "Practice out loud — avoid monologues over 3 minutes.",
    "resources.hr.item2.title": "2 · Behavioural / situational (STAR)",
    ...
    "resources.hr.item3.title": "3 · Past projects — prove you know your work",
    "resources.hr.item3.why": "HR/recruiters often drill 1–2 CV projects to catch resume inflation.",
    "resources.hr.item3.t1": "Pick your 2 latest projects: problem, your scope, trade-offs, outcome, stack — explain without slides.",
    "resources.hr.item3.t2": "Walk through flow / architecture at a high level; be ready to justify one technical decision you owned.",
    ...
    "resources.hr.item4.t1": "Research 3 specifics: product, culture/values, role scope — not just “big company”.",
    "resources.hr.item4.t2": "Tie motivation to your 2–3 year career goal.",
    "resources.hr.item4.t3": "Don't trash your current employer; comp is only part of the answer.",
    "resources.hr.item5.title": "5 · Logistics & professionalism",
    ...
    "resources.hr.item5.t2": "Prepare 2–3 questions back: process, team structure, timeline of next rounds.",
    "resources.hr.item5.t3": "Test mic/line; quiet space; CV + JD open in front of you.",
    "resources.hr.item6.title": "6 · After the call",
    ...
    "resources.hr.item6.t2": "Short thank-you within 24h (optional but boosts impression).",
