...
window.I18N = {
  vi: {
    ...
    "terms.body.html":
      ...
      '<p>Các dịch vụ cộng đồng của EngineerPro, bao gồm <strong>review CV, hỗ trợ xin việc, chia sẻ tài liệu/record, tư vấn 1-1 và tham gia Alumni</strong>, là các dịch vụ <strong>miễn phí</strong> và không bao gồm trong học phí đã đóng của học viên. EngineerPro có quyền tạm dừng hoặc ngừng cung cấp các dịch vụ này nếu cảm thấy các hoạt động không còn phù hợp hoặc không đáp ứng được yêu cầu của cộng đồng. Ngoài ra, chúng tôi cũng bảo lưu quyền từ chối cung cấp các dịch vụ này cho học viên trong trường hợp có xung đột lợi ích hoặc khi không còn phù hợp.</p>' +
