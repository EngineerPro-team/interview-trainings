...
window.I18N = {
  vi: {
    ...
    "resources.intro":  "Bộ tài nguyên miễn phí — bấm từng nhóm (CV, HR checklist, PIP Big Tech, Golang, Programming Foundation) để xem chi tiết.",
    ...
    "resources.pip.sub": "Thoát PIP hiếm khi thành công — ưu tiên negotiate mutual severance (N+1, N+2…) có lợi cho bạn.",
    ...
    "resources.pip.item3.t2": "Khung thương lượng: severance theo tháng lương (N+1, N+2… tùy level, tenure, và leverage), không chỉ statutory minimum.",
    ...
    "resources.pip.item4.t1": "Cash: base severance (N+1 / N+2 / higher), signing bonus clawback waiver, unpaid bonus cycle, relocation repayment waiver.",
  ...
  en: {
    ...
    "resources.head":   "Interview Resources",
    "resources.badge":  "FREE",
    "resources.intro":  "Free resources — click each group (CV kit, HR checklist, PIP Big Tech, Golang, Programming Foundation) to expand.",
    ...
    "resources.pip.kicker": "⚠️ GUIDE · PIP BIG TECH",
    "resources.pip.head": "How to handle PIP — Axon, Grab, TikTok, Shopee, Nvidia, Google, Amazon…",
    "resources.pip.sub": "Escaping PIP rarely works — prioritize negotiating mutual severance (N+1, N+2…) in your favor.",
    ...
    "resources.pip.item3.t2": "Negotiation frame: severance in months of pay (N+1, N+2… by level, tenure, leverage), not statutory minimum only.",
