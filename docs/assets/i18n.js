...
window.I18N = {
  vi: {
    ...
    "nav.schedule":   "Lịch khai giảng",
    "nav.book":       "Coding Book",
    "nav.systemDesign": "System design material",
    "nav.mock":       "Mock 1-1",
    ...
    "sched.cta.allCourses": "Xem tất cả khoá học →",
    "sched.july":        "Tháng 7 · 2026",
    "sched.june":        "Tháng 6 · 2026",
    "sched.openPill":    "Đang tuyển sinh",
    "sched.detail":      "Chi tiết",
    "sched.reserve":     "Giữ chỗ",
    "sched.note":        "* Lịch có thể điều chỉnh theo số lượng đăng ký. Inbox fanpage EngineerPro để được tư vấn lộ trình & nhận ưu đãi early-bird.",
    "sched.dsa1.day":    "Thứ 3 hàng tuần",
    "sched.dsa1.dur":    "22 buổi · 11 tuần",
    "sched.dsa2.day":    "Thứ 4 & Chủ nhật",
    "sched.dsa2.dur":    "16 buổi · 8 tuần",
    "sched.cs.day":      "Thứ 7 hàng tuần",
    "sched.cs.dur":      "12 buổi · 12 tuần",
    "sched.redis.day":   "Thứ 7 hàng tuần",
    "sched.redis.dur":   "10 buổi · 10 tuần",
    "sched.sd1.day":     "Chủ nhật hàng tuần",
    "sched.sd1.dur":     "12 buổi · 12 tuần",
    "sched.bego.day":    "Thứ 7 hàng tuần",
    "sched.bego.dur":    "12 buổi · 12 tuần",
    ...
    "book.author.cofounder": "Co-founder",
    "book.author.linkedin":  "LinkedIn",
    ...
    "sd.disclaimer.title":  "Tài liệu tham khảo mở đường — vượt vòng phỏng vấn cần luyện đúng chuẩn",
    "sd.disclaimer.body.html":
      '<p>Trên mạng có không ít tài liệu System Design miễn phí. Sau khi đọc, bạn có thể phác thảo kiến trúc và nhắc lại các pattern quen thuộc — song vòng phỏng vấn thực tế là <strong>45 phút trình bày</strong> trước những kỹ sư đã triển khai hệ thống quy mô lớn: làm rõ yêu cầu, đi sâu đúng phạm vi, đưa ra trade-off có căn cứ, và thể hiện signal phù hợp <strong>level ứng tuyển</strong> (junior / mid / senior).</p><p>Mỗi Big Tech — Google, Meta, TikTok, Amazon, Microsoft, WorldQuant, Grab, Nvidia, Shopee, Axon… — đều có <strong>chuẩn tuyển dụng riêng</strong>: cùng một đề bài nhưng kỳ vọng về ownership, khả năng scale và cách trình bày không giống nhau. Không tồn tại checklist chung cho mọi công ty.</p><p>Bộ ghi chú này hỗ trợ bạn <strong>ôn tập case study và thuật ngữ</strong>. Để nắm được <em>cách mở đầu súc tích</em>, <em>signal mà interviewer đánh giá</em>, và <em>định hướng theo từng công ty / level</em> — hãy luyện tập cùng mentor:</p>',
    "sd.cta.l1":            "Khóa System Design Big Tech →",
    "sd.cta.l2":            "Khóa System Design Level 2 →",
    "sd.cta.mock":          "Mock System Design 1-1 →",
    "sd.chapter.refNote":   "Ghi chú mang tính tham khảo — hỗ trợ ôn case study & thuật ngữ.",
    "sd.chapter.promo.lead": "Luyện trình bày System Design đúng chuẩn tuyển dụng theo level & công ty:",
    "sd.chapter.promo.fanpage": "Đăng ký qua fanpage →",
    "sd.chapter.back":      "← Quay lại danh sách chương",
    "sd.chapter.loading":   "Đang tải chương…",
    "sd.chapter.error":     "Không tải được nội dung chương. Thử tải lại trang.",
    "sd.chapter.comingSoon":"Chương này đang được dịch — sắp có bản tiếng Việt &amp; tiếng Anh.",
    "sd.chapter.badgeSoon": "Sắp có",
    ...
    "resources.formats.sub": "15 công ty · tổng hợp từ EngineerPro cheatsheet V2 — mang tính tham khảo.",
    ...
    "footer.link.schedule":  "Lịch khai giảng",
    "footer.link.book":          "Coding Book",
    "footer.link.systemDesign":  "System design material",
    ...
    "mock.sd.body":      "Thiết kế hệ thống realtime với interviewer — clarify requirements, high-level design, deep-dive component, trade-off, scale-up. Feedback theo signal rubric của Big Tech cho từng level (junior / mid / senior).",
  ...
  en: {
    ...
    "sched.cta.allCourses": "See all courses →",
    "sched.july":        "July · 2026",
    "sched.june":        "June · 2026",
    "sched.openPill":    "Enrolling now",
    "sched.detail":      "Details",
    "sched.reserve":     "Reserve",
    "sched.note":        "* Schedule may shift based on enrolment. Inbox the EngineerPro fanpage for roadmap advice & early-bird offers.",
    "sched.dsa1.day":    "Every Tuesday",
    "sched.dsa1.dur":    "22 sessions · 11 weeks",
    "sched.dsa2.day":    "Wednesday & Sunday",
    "sched.dsa2.dur":    "16 sessions · 8 weeks",
    "sched.cs.day":      "Every Saturday",
    "sched.cs.dur":      "12 sessions · 12 weeks",
    "sched.redis.day":   "Every Saturday",
    "sched.redis.dur":   "10 sessions · 10 weeks",
    "sched.sd1.day":     "Every Sunday",
    "sched.sd1.dur":     "12 sessions · 12 weeks",
    "sched.bego.day":    "Every Saturday",
    "sched.bego.dur":    "12 sessions · 12 weeks",
    ...
    "sd.disclaimer.title":  "Reference material opens the door — clearing the interview takes calibrated practice",
    "sd.disclaimer.body.html":
      '<p>Free System Design resources are abundant online. After reading, you can sketch architectures and recall familiar patterns — yet the live interview is <strong>45 minutes of structured presentation</strong> before engineers who have shipped systems at scale: clarifying requirements, diving to the right depth, trade-offs with sound reasoning, and signals aligned with your <strong>target level</strong> (junior / mid / senior).</p><p>Each Big Tech company — Google, Meta, TikTok, Amazon, Microsoft, WorldQuant, Grab, Nvidia, Shopee, Axon… — sets its own <strong>hiring bar</strong>: the same prompt carries different expectations on ownership, scalability, and how you communicate. No universal checklist applies everywhere.</p><p>These notes support <strong>case-study review and terminology</strong>. To master <em>concise openings</em>, <em>the signals interviewers evaluate</em>, and <em>guidance tailored to company and level</em> — train with mentors:</p>',
    "sd.cta.l1":            "SD Big Tech course →",
    "sd.cta.l2":            "SD Level 2 course →",
    "sd.cta.mock":          "Mock System Design 1-1 →",
    "sd.chapter.refNote":   "Reference notes — for case-study review & terminology.",
    "sd.chapter.promo.lead": "Practice System Design presentation at the right hiring bar by level & company:",
    "sd.chapter.promo.fanpage": "Register via Fanpage →",
    "sd.chapter.back":      "← Back to chapter list",
    "sd.chapter.loading":   "Loading chapter…",
    "sd.chapter.error":     "Could not load this chapter. Try refreshing the page.",
    "sd.chapter.comingSoon":"This chapter is being translated — VI &amp; EN coming soon.",
    "sd.chapter.badgeSoon": "Soon",
    ...
    "resources.formats.sub": "15 companies · from EngineerPro cheatsheet V2 — reference only.",
    ...
    "footer.link.schedule":  "Course Schedule",
    "footer.link.book":          "Coding Book",
    "footer.link.systemDesign":  "System design material",
    ...
    "mock.sd.kicker":    "🏗 SYSTEM DESIGN",
    "mock.sd.title":     "Mock System Design",
    "mock.sd.body":      "Live system-design session with an interviewer — clarify requirements, high-level design, deep-dive a component, trade-offs, scale-up. Feedback against the Big Tech signal rubric for each level (junior / mid / senior).",
    "mock.dsa.kicker":   "💻 DSA / CODING",
    "mock.dsa.title":    "Mock DSA / Coding Interview",
