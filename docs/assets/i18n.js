...
window.I18N = {
  vi: {
    ...
    "nav.books":      "Sách & Tài liệu",
    "nav.book":       "Coding Book",
    "nav.ebooks":     "E-books (Gumroad)",
    "ebooks.head":    "E-books",
    "ebooks.intro":   "Sách điện tử do team EngineerPro biên soạn — mua trực tiếp trên Gumroad, tải PDF về đọc ngay.",
    ...
    "sched.sd2.dur":     "12 buổi · 12 tuần",
    "sched.beh.day":     "Tối T2 & chiều T7 hàng tuần",
    "sched.beh.time":    "T2 21:30–23:30 · T7 14:00–16:00",
    "sched.beh.dur":     "12 buổi · 6 tuần",
    "sched.ml.day":      "Tối T2 & T5 hàng tuần",
    "sched.ml.dur":      "10 buổi · 5 tuần",
    "sched.openPill":    "Đang tuyển sinh",
    "sched.detail":      "Chi tiết",
    "sched.reserve":     "Giữ chỗ qua FB",
    ...
    "sched.dsa1.day":    "Thứ 3 & Thứ 7 hàng tuần",
    ...
    "sched.trust.students": "học viên đã đào tạo",
    "sched.trust.offers":   "offers Big Tech",
    "sched.trust.mentor":   "mentor từ Big Tech",
    "sched.trust.online":   "record xem lại trọn đời",
    "sched.why.head":    "Vì sao chọn EngineerPro?",
    "sched.why.1.t":     "Mentor 100% Big Tech",
    "sched.why.1.d":     "Trực tiếp dạy & review bởi kỹ sư đang làm tại Google, Meta, Amazon, TikTok, Grab, Shopee…",
    "sched.why.2.t":     "Lộ trình thực chiến",
    "sched.why.2.d":     "Bám sát hiring bar Big Tech — học tới đâu luyện đề & mock tới đó, không lý thuyết suông.",
    "sched.why.3.t":     "Online linh hoạt",
    "sched.why.3.d":     "Lớp live qua Zoom theo lịch cố định, có record xem lại trọn đời — phù hợp người đi làm.",
    "sched.why.4.t":     "Đồng hành sau khoá",
    "sched.why.4.d":     "Support cả sau khi kết thúc khoá, group nội bộ, thông tin tuyển dụng & referral từ mentor.",
    "sched.steps.head":  "Đăng ký chỉ 3 bước",
    "sched.steps.1.t":   "Inbox fanpage",
    "sched.steps.1.d":   "Nhắn EngineerPro qua Messenger/Zalo, chọn lớp bạn quan tâm.",
    "sched.steps.2.t":   "Tư vấn lộ trình",
    "sched.steps.2.d":   "Đội ngũ EP tư vấn lộ trình phù hợp trình độ & mục tiêu của bạn.",
    "sched.steps.3.t":   "Giữ chỗ & nhập học",
    "sched.steps.3.d":   "Hoàn tất giữ chỗ để nhận ưu đãi early-bird và vào lớp đúng ngày khai giảng.",
    "sched.final.head":  "Sẵn sàng bứt phá cùng Big Tech?",
    "sched.final.sub":   "Mỗi lớp giới hạn số lượng để đảm bảo chất lượng mentoring. Inbox ngay để giữ chỗ lớp tháng này.",
    "sched.final.inbox": "Inbox Messenger",
    "sched.final.zalo":  "Nhắn Zalo",
    ...
    "mentors.intro.html":
      '<span id="mentorsCount">20</span> mentor đang làm việc tại Google, Amazon, Meta, TikTok, Spotify, Shopee, Acronis, AWS… Bấm vào nút LinkedIn để xem profile.',
  ...
  en: {
    ...
    "nav.books":      "Books & Materials",
    "nav.book":       "Coding Book",
    "nav.ebooks":     "E-books (Gumroad)",
    "ebooks.head":    "E-books",
    "ebooks.intro":   "E-books written by the EngineerPro team — buy directly on Gumroad and download the PDF instantly.",
    "nav.systemDesign": "System design material",
    "nav.mock":       "Mock 1-1",
    "nav.resources":  "Resources",
    "nav.mentors":    "Mentors",
    ...
    "sched.sd2.dur":     "12 sessions · 12 weeks",
    "sched.beh.day":     "Mon evening & Sat afternoon",
    "sched.beh.time":    "Mon 21:30–23:30 · Sat 14:00–16:00",
    "sched.beh.dur":     "12 sessions · 6 weeks",
    "sched.ml.day":      "Mon & Thu evenings",
    "sched.ml.dur":      "10 sessions · 5 weeks",
    "sched.openPill":    "Enrolling now",
    "sched.detail":      "Details",
    "sched.reserve":     "Reserve via FB",
    "sched.note":        "* Schedule may shift based on enrolment. Inbox the EngineerPro fanpage for roadmap advice & early-bird offers.",
    "sched.dsa1.day":    "Tuesday & Saturday",
    ...
    "sched.trust.students": "students trained",
    "sched.trust.offers":   "Big Tech offers",
    "sched.trust.mentor":   "mentors from Big Tech",
    "sched.trust.online":   "lifetime session replays",
    "sched.why.head":    "Why EngineerPro?",
    "sched.why.1.t":     "100% Big Tech mentors",
    "sched.why.1.d":     "Taught & reviewed directly by engineers currently at Google, Meta, Amazon, TikTok, Grab, Shopee…",
    "sched.why.2.t":     "Battle-tested roadmap",
    "sched.why.2.d":     "Aligned to the Big Tech hiring bar — every topic comes with drills & mock interviews, no dry theory.",
    "sched.why.3.t":     "Flexible online",
    "sched.why.3.d":     "Live Zoom classes on a fixed schedule with lifetime replays — ideal for working professionals.",
    "sched.why.4.t":     "Support beyond the course",
    "sched.why.4.d":     "Ongoing support after the course ends, a private group, job leads & referrals from mentors.",
    "sched.steps.head":  "Enroll in just 3 steps",
    "sched.steps.1.t":   "Inbox the fanpage",
    "sched.steps.1.d":   "Message EngineerPro on Messenger/Zalo and pick the class you want.",
    "sched.steps.2.t":   "Roadmap consultation",
    "sched.steps.2.d":   "The EP team advises a roadmap that fits your level & goals.",
    "sched.steps.3.t":   "Reserve & join",
    "sched.steps.3.d":   "Confirm your seat to lock in the early-bird offer and join on the launch date.",
    "sched.final.head":  "Ready to break into Big Tech?",
    "sched.final.sub":   "Each class has limited seats to keep mentoring quality high. Inbox now to reserve this month's cohort.",
    "sched.final.inbox": "Inbox Messenger",
    "sched.final.zalo":  "Message on Zalo",
    ...
    "mentors.intro.html":
      '<span id="mentorsCount">20</span> mentors currently at Google, Amazon, Meta, TikTok, Spotify, Shopee, Acronis, AWS… Click LinkedIn to see their profile.',
    "mentors.cta.linkedin": "LinkedIn",
