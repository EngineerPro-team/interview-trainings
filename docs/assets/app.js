  ...
  function updateSeoForRoute(route, slug) {
    ...
    if (route === "course") {
      ...
      const ROUTE_DESC = {
        ...
        mentors:   en ? "17 mentors currently at Google, Amazon, Meta, TikTok, Spotify, Shopee, Acronis, AWS…" : "17 mentor đang làm tại Google, Amazon, Meta, TikTok, Spotify, Shopee, Acronis, AWS…",
        stories:   en ? "95+ EngineerPro students landed offers at Google, Meta, Amazon, TikTok, Microsoft, Grab, Shopee, NAB, ANZ…" : "95+ học viên EngineerPro chinh phục offer tại Google, Meta, Amazon, TikTok, Microsoft, Grab, Shopee, NAB, ANZ…",
